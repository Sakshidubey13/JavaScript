...
function ShowCartitems() {
  ...
  cart.forEach((items) => {
    ...
    div.innerHTML = `<img src="${items.productimg}" alt="${items.title}">
...
function increseQty(id) {
  //cart ke array me product element => us pro ki id === click ki huii ki product ki id dono same honi chhiye tabhi increase hoga
...
function removeitem(id) {
  //hmne filter func ka use kiya jo ek element ko hata ke usse update krne kaa kaam krta h
...
function UpdateItems() {
  //yeh settitme kyy krta h smjo mere pss ek page h mene ek data likha ussme fir baad me mene usse kaat ke new data likha diya iska mtlb yehi h
